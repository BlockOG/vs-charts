...
if (!url.searchParams.has("chart")) window.location.href = "/hidden";

const chart = url.searchParams.get("chart");
fetch("/hidden/song_data.json").then((data) => {
    data.json().then((data) => {
                                ...
                                if (curr_height > 0) {
                                    ...
                                    images.push(
                                        img({
                                            ...
                                            src: `/hidden/charts/${chart}/${difficulty_names[difficulty.val]}${show_bpm.val ? "-bpm" : ""}.png`,
                                        })
                                    );
